...
<div class="container">
	...
	<p class="h3">Proyecto Spring Tool Suite 3</p>
	<p class="h5">El proyecto Spring Tool Suite (https://spring.io/tools) proporciona un excelente 
	entorno para el desarrollo de aplicaciones que utilicen Spring Framework. Spring Tool Suite se 
	integra sobre la plataforma Eclipse (http://www.eclipse.org/) y también da soporte al servidor 
	web (en nuestro caso Tomcat); sin embargo, podemos preparar el entorno desde el IDE Ecplise con 
	las librerias necesarias.</p>
